...
namespace OpenTK_winforms_z02
{
    public partial class Form1 : Form
    {
        ...
        private bool piramidat1;
        private bool obiect1t1;
        private bool obiect2t1;

        private bool piramidat2;
        private bool obiect1t2;
        private bool obiect2t2;
        ...
        private List<Vector3> fete = new List<Vector3>(); // piramida fete
        private List<Vector3> baza = new List<Vector3>(); // piramida baza

        private List<Vector3> fete1 = new List<Vector3>(); // obiect 1

        private List<Vector3> fete2 = new List<Vector3>(); // obiect 2
        ...
        private void loadPiramida()
        {
            ...
            while ((ln = f.ReadLine()) != null)
            {
                if (ln.Split(' ')[0] == "f")
                {
                    fete.Add(new Vector3(Int32.Parse(ln.Split(' ')[1]), Int32.Parse(ln.Split(' ')[2]), Int32.Parse(ln.Split(' ')[3])));
                }
        ...
        private void loadObiect1()
        {
            ...
            while ((ln = f.ReadLine()) != null)
            {
                if (ln.Split(' ')[0] == "f")
                {
                    fete1.Add(new Vector3(Int32.Parse(ln.Split(' ')[1]), Int32.Parse(ln.Split(' ')[2]), Int32.Parse(ln.Split(' ')[3])));
                }
            }
        ...
        private void loadObiect2()
        {
            ...
            while ((ln = f.ReadLine()) != null)
            {
                if (ln.Split(' ')[0] == "f")
                {
                    fete2.Add(new Vector3(Int32.Parse(ln.Split(' ')[1]), Int32.Parse(ln.Split(' ')[2]), Int32.Parse(ln.Split(' ')[3])));
                }
            }
        ...
        private void DeseneazaPiramida_Tex1()
        {
            ...
            for (int i = 0; i < fete.Count; i = i + 6)
            {
        ...
        private void DeseneazaObiect1_Tex1()
        {
            ...
            for (int i = 0; i < fete1.Count; i = i + 4)
            {
                GL.TexCoord2(0.0, 1.0);
                GL.Vertex3(fete1[i]);
                GL.TexCoord2(1.0, 1.0);
                GL.Vertex3(fete1[i + 1]);
                GL.TexCoord2(1.0, 0.0);
                GL.Vertex3(fete1[i + 2]);
                GL.TexCoord2(0.0, 0.0);
                GL.Vertex3(fete1[i + 3]);
            }
        ...
        private void DeseneazaObiect2_Tex1()
        {
            ...
            for (int i = 0; i < fete2.Count; i = i + 4)
            {
                GL.TexCoord2(0.0, 1.0);
                GL.Vertex3(fete2[i]);
                GL.TexCoord2(1.0, 1.0);
                GL.Vertex3(fete2[i + 1]);
                GL.TexCoord2(1.0, 0.0);
                GL.Vertex3(fete2[i + 2]);
                GL.TexCoord2(0.0, 0.0);
                GL.Vertex3(fete2[i + 3]);
            }
